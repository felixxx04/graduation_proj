...
--
-- 前置条件：
--   1. 数据库为 v1 版本（角色: admin/doctor/researcher，存在 doctor1 和 researcher1）
--   2. review_log 表已创建（通过 review_log.sql）
--   3. 不在 v2 init_data.sql 之后运行（v2 init_data.sql 已包含新账号）
--
