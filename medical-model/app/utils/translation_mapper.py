...
FIELD_NAME_ZH: Dict[str, str] = {
    ...
    "bmi_group": "BMI分组",
    "renal_function": "肾功能",
    "hepatic_function": "肝功能",
    "primary_disease": "主诊断",
    "secondary_disease": "次诊断",
    "allergy_severity": "过敏严重度",
    "drug_class": "药物类别",
    "med_class_1": "当前用药1",
    "med_class_2": "当前用药2",
    "med_class_3": "当前用药3",
...
CONDITION_ZH_CORE: Dict[str, str] = {
    ...
    "c. difficile": "艰难梭菌",
    # ── 60个补充翻译（之前返回英文的病况） ──
    "drug-induced extrapyramidal symptoms": "药物性锥体外系症状",
    "dyslipidemia": "血脂异常",
    "dyspepsia": "消化不良",
    "dyspepsia (as antacid)": "消化不良（抗酸药用途）",
    "high cardiovascular risk with low hdl": "高心血管风险伴低HDL",
    "niacin deficiency": "烟酸缺乏",
    "niacin deficiency (pellagra)": "烟酸缺乏（糙皮病）",
    "nocturia": "夜尿",
    "nocturnal enuresis": "夜间遗尿",
    "nocturnal leg cramps": "夜间腿部抽筋",
    "non-Hodgkin lymphoma": "非霍奇金淋巴瘤",
    "non-alcoholic fatty liver disease": "非酒精性脂肪肝",
    "non-alcoholic steatohepatitis": "非酒精性脂肪性肝炎",
    "non-allergic rhinitis": "非过敏性鼻炎",
    "non-cystic fibrosis bronchiectasis": "非囊性纤维化支气管扩张",
    "non-hodgkin's lymphoma": "非霍奇金淋巴瘤",
    "non-infectious diarrhea in hiv patients on antiretroviral therapy": "HIV抗逆转录病毒治疗患者非感染性腹泻",
    "non-metastatic castration-resistant prostate cancer": "非转移性去势抵抗性前列腺癌",
    "non-small cell lung cancer": "非小细胞肺癌",
    "non-small cell lung cancer with braf v600e mutation": "BRAF V600E突变非小细胞肺癌",
    "non-small cell lung cancer with egfr mutations": "EGFR突变非小细胞肺癌",
    "non-transfusion-dependent thalassemia with iron overload": "非输血依赖性地中海贫血伴铁过载",
    "nonalcoholic steatohepatitis": "非酒精性脂肪性肝炎",
    "nonproductive cough": "干咳",
    "nosocomial pneumonia": "院内感染性肺炎",
    "nsaid-induced gastric ulcer prophylaxis": "NSAID致胃溃疡预防",
    "nsaid-induced ulcer prevention": "NSAID致溃疡预防",
    "nsaid-induced ulcer prophylaxis": "NSAID致溃疡预防",
    "obesity (short-term adjunct)": "肥胖（短期辅助）",
    "obesity management": "肥胖管理",
    "obsessive-compulsive disorder": "强迫症",
    "obstetric analgesia": "产科镇痛",
    "obstructive sleep apnea": "阻塞性睡眠呼吸暂停",
    "occlusion of central venous catheters": "中心静脉导管阻塞",
    "ocular cycloplegia": "眼睫状肌麻痹",
    "ocular infections (topical)": "眼部感染（局部用药）",
    "oliguric renal failure prophylaxis": "少尿性肾衰竭预防",
    "onchocerciasis": "盘尾丝虫病",
    "onychomycosis": "甲真菌病",
    "opioid overdose": "阿片类药物过量",
    "opioid overdose prevention": "阿片类药物过量预防",
    "opioid use disorder": "阿片类药物使用障碍",
    "opioid use disorder relapse prevention": "阿片类药物使用障碍复发预防",
    "opioid-induced constipation in patients with advanced illness": "晚期疾病患者阿片致便秘",
    "opioid-induced constipation not responsive to standard laxatives": "阿片致便秘（标准泻药无效）",
    "oral mucositis": "口腔黏膜炎",
    "oral pain": "口腔疼痛",
    "oral thrush": "口腔念珠菌病",
    "oropharyngeal candidiasis": "口咽念珠菌病",
    "orthostatic hypotension": "直立性低血压",
    "osteoarthritis pain": "骨关节炎疼痛",
    "osteogenesis imperfecta": "成骨不全症",
    "osteolytic bone metastases of breast cancer": "乳腺癌溶骨性骨转移",
    "osteolytic lesions of multiple myeloma": "多发性骨髓瘤溶骨性病变",
    "osteomalacia": "骨软化症",
    "osteomyelitis": "骨髓炎",
    "osteopetrosis": "骨硬化症",
    "osteoporosis prevention": "骨质疏松预防",
    "osteoporosis treatment": "骨质疏松治疗",
    "otitis externa": "外耳道炎",

    # ── 92个补充翻译（覆盖所有剩余英文病况） ──
    "amyotrophic lateral sclerosis (als)": "肌萎缩侧索硬化症(ALS)",
    "anaerobic bacterial infections": "厌氧菌感染",
    "antacid": "抗酸药用途",
    "anxiety disorders": "焦虑症",
    "appetite stimulant (cachexia)": "食欲刺激(恶病质)",
    "atrial fibrillation/flutter": "心房颤动/心房扑动",
    "autoimmune disorders (ra": "自身免疫性疾病(类风湿",
    "bacterial eye infections": "细菌性眼部感染",
    "bacterial infections": "细菌感染",
    "bacterial infections (e.g.": "细菌感染(如",
    "bacterial infections (often combined with trimethoprim)": "细菌感染(常与甲氧苄啶合用)",
    "bacterial skin infections": "细菌性皮肤感染",
    "bardet-biedl syndrome": "巴德-比德尔综合征",
    "brain tumors": "脑肿瘤",
    "carnitine deficiency": "肉碱缺乏症",
    "cdkl5 deficiency disorder": "CDKL5缺乏症",
    "chemotherapy-induced nausea/vomiting": "化疗致恶心/呕吐",
    "chronic lymphocytic leukemia (cll)": "慢性淋巴细胞白血病(CLL)",
    "chronic myeloid leukemia (cml)": "慢性髓系白血病(CML)",
    "complicated infections": "复杂性感染",
    "complicated skin infections": "复杂性皮肤感染",
    "cytomegalovirus (cmv) infections": "巨细胞病毒(CMV)感染",
    "cytomegalovirus (cmv) retinitis": "巨细胞病毒(CMV)视网膜炎",
    "dementia (cognitive decline)": "痴呆(认知衰退)",
    "diarrhea caused by cryptosporidium or giardia": "隐孢子虫或贾第鞭毛虫致腹泻",
    "dravet syndrome": "Dravet综合征",
    "edema (heart failure": "水肿(心力衰竭",
    "fungal infections": "真菌感染",
    "fungal infections (oral": "真菌感染(口腔",
    "fungal infections of skin": "皮肤真菌感染",
    "fungal nail infections": "甲真菌感染",
    "fungal skin infections (e.g.": "皮肤真菌感染(如",
    "gi spasms": "胃肠痉挛",
    "growth failure": "生长迟缓",
    "heart failure (short-term)": "心力衰竭(短期)",
    "hepatitis b": "乙型肝炎",
    "hepatitis b/c": "乙型/丙型肝炎",
    "hepatitis c": "丙型肝炎",
    "herpes simplex virus (hsv) infections": "单纯疱疹病毒(HSV)感染",
    "hiv infection (often as booster)": "HIV感染(常作为增强剂)",
    "hormone replacement": "激素替代",
    "hyperparathyroidism": "甲状旁腺功能亢进",
    "hyperphosphatemia in ckd": "慢性肾病高磷血症",
    "induction/maintenance of anesthesia": "麻醉诱导/维持",
    "inflammatory skin conditions": "炎症性皮肤病",
    "influenza a virus infection": "甲型流感病毒感染",
    "influenza b virus infection": "乙型流感病毒感染",
    "invasive fungal infections": "侵袭性真菌感染",
    "iron overload": "铁过载",
    "local / regional anesthesia": "局部/区域麻醉",
    "malaria (chloroquine-resistant)": "疟疾(氯喹耐药)",
    "malaria (in combination)": "疟疾(联合用药)",
    "malaria (radical cure for p. vivax/ovale)": "疟疾根治(间日疟/卵形疟)",
    "malaria prevention and treatment": "疟疾预防和治疗",
    "melanoma (braf v600e mutation)": "黑色素瘤(BRAF V600E突变)",
    "mri contrast": "MRI造影",
    "muscle spasms": "肌肉痉挛",
    "mycobacterium avium complex (mac) prophylaxis": "鸟型分枝杆菌复合体(MAC)预防",
    "nausea/vomiting": "恶心/呕吐",
    "non-small cell lung cancer (nsclc)": "非小细胞肺癌(NSCLC)",
    "obesity (short-term)": "肥胖(短期)",
    "obsessive-compulsive disorder (ocd)": "强迫症(OCD)",
    "opioid-induced constipation": "阿片致便秘",
    "osteoporosis prevention/treatment in postmenopausal women": "绝经后女性骨质疏松预防/治疗",
    "pain (including menstrual)": "疼痛(含痛经)",
    "pain (short-term management)": "疼痛(短期管理)",
    "parasitic infections": "寄生虫感染",
    "parasitic worm infections": "蠕虫感染",
    "paroxysmal nocturnal hemoglobinuria (pnh)": "阵发性夜间血红蛋白尿症(PNH)",
    "pneumocystis jirovecii pneumonia (pcp)": "肺孢子菌肺炎(PCP)",
    "pneumocystis jirovecii pneumonia (pcp) prophylaxis and treatment": "肺孢子菌肺炎(PCP)预防与治疗",
    "post-cardiac valve replacement": "心脏瓣膜置换术后",
    "prevent/treat postpartum hemorrhage": "预防/治疗产后出血",
    "prevention of hemorrhagic cystitis": "出血性膀胱炎预防",
    "prevention of nsaid-induced ulcers": "NSAID致溃疡预防",
    "prevention of varicella (chickenpox)": "水痘预防",
    "pulmonary arterial hypertension (pah)": "肺动脉高压(PAH)",
    "reduced intracranial/intraocular pressure": "降低颅内/眼内压",
    "serious bacterial infections": "严重细菌感染",
    "serious bacterial infections (e.g.": "严重细菌感染(如",
    "serious infections (e.g.": "严重感染(如",
    "stroke prevention (alternative)": "中风预防(替代方案)",
    "thromboembolism prevention/treatment": "血栓栓塞预防/治疗",
    "topical skin infections": "局部皮肤感染",
    "topical skin infections (impetigo)": "局部皮肤感染(脓疱病)",
    "type 1 & 2 diabetes (adjunct)": "1型和2型糖尿病(辅助)",
    "uncomplicated utis": "单纯性尿路感染",
    "utis (often combined with sulfamethoxazole)": "尿路感染(常与磺胺甲恶唑合用)",
    "vaginal yeast infections": "阴道酵母菌感染",
    "various cancers": "各类癌症",
    "vte prophylaxis and treatment": "静脉血栓栓塞预防与治疗",
